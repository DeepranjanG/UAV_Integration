...
class ObjectDetector:
    ...
    def __init__(self):
        ...
        self.saved_model_loaded = tf.saved_model.load('/home/deepu/catkin_ws/src/hector_quadrotor_sim/takeoff_land/src/yolov4/saved_model', tags=[tag_constants.SERVING])
